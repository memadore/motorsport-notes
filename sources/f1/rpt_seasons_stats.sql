...
select
    ...
    calendar.race_count,
    if(season.year = date_part('year', current_date()), null, world_champion.driver_world_champion) as driver_world_champion,
    if(season.year = date_part('year', current_date()), null, world_champion.constructor_world_champion) as constructor_world_champion,
